      ...
      child: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            TextFormField(
              decoration: InputDecoration(
                labelText: 'Contact Number of a Guardian',
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(10.0),
                  borderSide: BorderSide(
                    color: Colors.blue,
              ...
              validator: (value) {
                if (value == null || value.isEmpty) {
                  return 'Please enter contact number of a responsible person';
                } else {
                  _contact = value;
                }
              },
              ...
              onPressed: () async {
                if (_formKey.currentState!.validate()) {
                  ...
                  setState(() {
                    ...
                    if (suc != 1) {
                      errorMessage = "Registration Failed. Check Network and Try again";
                    }
                  });
                }
              },
